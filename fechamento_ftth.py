...
tabela_Movel = pd.read_csv('/home/math/Documents/fechamento/fixa.csv', delimiter=';', encoding='utf-8-sig')
...
def separarExcel(executivo):
    vendas_Executivo = tabela_Movel.loc[tabela_Movel['VENDEDOR'] == executivo]
    ...
    vendas_Executivo.to_excel(f'/home/math/Documents/fechamento/convertidos/vendas_Fixa_{nomeSemAcento}.xlsx', index=False, engine='openpyxl')
